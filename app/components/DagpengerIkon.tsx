export function DagpengerIkon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 96.45 96.44">
      <g clipPath="url(#clip0_4486_7567)">
        ...
        <path d="M77.8105 77.7964L94.9534 94.9392" stroke="#262626" strokeWidth="3" />
        <path
